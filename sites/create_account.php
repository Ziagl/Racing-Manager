			...
			if($db_ftd->checkEmailDuplicate($email))
			{
		        ...
		        if(isset($_POST['password']) && strcmp($_POST['password'],'') != 0)
		        {
		            if(strcmp($_POST['password'], $_POST['password2']) == 0)
		            {
		                ...
		                if ($securimage->check($_POST['captcha_code']) == true)
		                {
		                    ...
		                    switch($ret)
		                    {
		                        case 0:
		                            ...
		                            $mail_text_array[9] = 'http://'.$host.$uri.'/?site=unsubscribe&email='.base64_encode($email).'&lang='.$language;	//unsibscribe link
					    ...
					    $encoded.= "subject=".urlencode(Translator::_translate('tr_create_account_email_subject'))."&";
